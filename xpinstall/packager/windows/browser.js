...
function createShortcuts() 
{
  ...
  if(winreg != null) 
  {
    ...
    subkey  = "SOFTWARE\\RetroZilla\\RetroZilla\\2.0 (en)\\Setup";
...
function registerMainKeys(winreg)
{
  ...
  if( IsWinnt() )
  {
    ...
    data = "\"" + fProgram + "uninstall\\retrozillaUninstall.exe\" /ua \"2.0 (en)\" /hs browser";
    ...
    data = "\"" + fProgram + "uninstall\\retrozillaUninstall.exe\" /ua \"2.0 (en)\" /ss browser";
...
srDest = 1;
err    = initInstall("RetroZilla", "Browser", "2.0.0.0000000000"); 
  ...
  if( err == SUCCESS )
  {
    ...
    if (err == SUCCESS)
    {
      ...
      if (! ('buildID' in Install))
      {
        ...
        initInstall("Post-install Cleanup Utility", "Browser/xpicleanup", "2.0.0.0000000000");
