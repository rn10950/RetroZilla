...
function createShortcuts() 
{
  ...
  if(winreg != null) 
  {
    ...
    if( IsWinnt() )
    {
      ...
      data = "\"" + fProgram + "uninstall\\retrozillaUninstall.exe\" /ua \"2.2 (en)\" /hs mail";
      ...
      data = "\"" + fProgram + "uninstall\\retrozillaUninstall.exe\" /ua \"2.2 (en)\" /ss mail";
...
srDest = 1;
err    = initInstall("RetroZilla Mail", "Mail", "2.2.0.0000000000"); 
