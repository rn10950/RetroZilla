...
function createShortcuts() 
{
  ...
  if(winreg != null) 
  {
    ...
    if( IsWinnt() )
    {
      ...
      data = "\"" + fProgram + "uninstall\\retrozillaUninstall.exe\" /ua \"2.1 (en)\" /hs mail";
      ...
      data = "\"" + fProgram + "uninstall\\retrozillaUninstall.exe\" /ua \"2.1 (en)\" /ss mail";
...
srDest = 1;
err    = initInstall("RetroZilla Mail", "Mail", "2.1.0.0000000000"); 
