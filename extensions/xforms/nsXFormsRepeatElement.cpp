...
protected:
  ...
  /**
   * Override of nsXFormsControlStubBase's function.  Needed to properly handle
   * the case where the repeat is generated by anonymous content to
...
nsXFormsRepeatElement::UpdateRepeatState(nsIDOMNode *aParent)
{
  ...
  return nsXFormsControlStubBase::UpdateRepeatState(aParent);
}
